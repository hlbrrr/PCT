...
public class CapacityJSpinner extends JSpinner {
    ...
    private class CapacitySpinnerNumberModel extends SpinnerNumberModel {
         ...
         */
        public CapacitySpinnerNumberModel(Component parent, boolean isDeprecated, Number value, Comparable minimum, Comparable maximum, Number stepSize) {
         ...
         *                                  <code>minimum &lt;= value &lt;= maximum</code>
         */
        public CapacitySpinnerNumberModel(Component parent, boolean isDeprecated, int value, int minimum, int maximum, int stepSize) {
            this(parent, isDeprecated, new Integer(value), new Integer(minimum), new Integer(maximum), new Integer(stepSize));
        }
         ...
         *                                  <code>minimum &lt;= value &lt;= maximum</code>
         */
        public CapacitySpinnerNumberModel(Component parent, boolean isDeprecated, double value, double minimum, double maximum, double stepSize) {
            this(parent, isDeprecated, new Double(value), new Double(minimum), new Double(maximum), new Double(stepSize));
        }
         ...
         */
        public CapacitySpinnerNumberModel(Component parent, boolean isDeprecated) {
            this(parent, isDeprecated, new Integer(0), null, null, new Integer(1));
        }
...
//        }
    ...
    public CapacityJSpinner(int initialCapacity, Component parent, boolean isDeprecated, String key) {
        super();
        setModel(new CapacitySpinnerNumberModel(parent, isDeprecated, initialCapacity, 0, Integer.MAX_VALUE, 1));
